...
const OrderList = (props) => {
  ...
  const _onSubmit = async (e) => {
    ...
    formdata.append('number_of_info', productDetails.number_of_info);
    formdata.append('from_currency', productDetails.from_currency);
    formdata.append('To_currency', productDetails.To_currency);
    formdata.append('Pyament_recive_no', productDetails.Pyament_recive_no);
